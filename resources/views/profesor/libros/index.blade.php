<x-app-layout>
    ...
    <div class="max-w-6xl mx-auto">
        <h1 class="text-3xl font-bold text-[var(--primary-color)] mb-6 text-center">Repositorio de Libros</h1>
        ...
        <div class="text-center mt-6">
            <button id="load-more" class="px-6 py-2 bg-gray-800 text-white font-semibold rounded-lg shadow-md hover:bg-opacity-90 hidden">
                Cargar más libros
            </button>
        </div>
    </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            const fetchBooks = async () => {
                ...
                try {
                    const apiUrl = `/dashboard/profesor/libros/list?page=${page}&search=${searchQuery}`;
                    ...
                    if (books.length === 0 && page === 1) {
                        bookContainer.innerHTML = `<p class="text-center text-gray-600">No se encontraron libros.</p>`;

<x-app-layout>
    <nav class="text-gray-600 text-sm mb-4">
        <a href="#" class="hover:underline">Inicio</a> / <span class="font-semibold">Tipos</span>
    </nav>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            function obtenerDatos(page = 1, query = '') {
                fetch(`/dashboard/tipos/list?page=${page}&search=${query}`, {
                        headers: {
            ...
            $("#formData").validate({
                ...
                messages: {
                    ...
                    imagen: {
                        required: "Debe subir una imagen de portada si está creando un nuevo tipo"
                    },
            ...
            function saveData() {
                ...
                let method = "POST";
                let url = rowId ? `/dashboard/tipos/${rowId}` : "/dashboard/tipos";
